...
def main():
    ...
    if args.uRank is not None:
        torch.save(model.state_dict(), "./weights/lowrank_compressed_{}.pt".format(args.model.lower()))
    else:
        torch.save(model.state_dict(), "./weights/full_{}.pt".format(args.model.lower()))
