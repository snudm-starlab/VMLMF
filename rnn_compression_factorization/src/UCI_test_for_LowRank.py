...
def main():
    ...
    if args.model.lower() == "mygru":
        model = Net(9, layer_sizes=args.layer_sizes, wRank=args.wRank, uRank=args.uRank, model=myGRU)
    elif args.model.lower() == "mylstm":
        model = Net(9, layer_sizes=args.layer_sizes, wRank=args.wRank, uRank=args.uRank, model=myLSTM)
