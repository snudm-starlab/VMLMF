...
from compressed_rnn import myGRU, myLSTM, DeepConv
import torch
...
def main():
    ...
    if args.model.lower() == "mygru":
        model = Net(576, layer_sizes=args.layer_sizes, wRank=args.wRank, uRank=args.uRank, model=myGRU)
    elif args.model.lower() == "mylstm":
        model = Net(576, layer_sizes=args.layer_sizes, wRank=args.wRank, uRank=args.uRank, model=myLSTM)
